...
-- @param  Char
-- @output Int
-- @description: returns corresponding value when given a digit 0-9, returns -1 otherwise
prob2 :: Char -> Int
prob2 '0' = 0
prob2 '1' = 1
prob2 '2' = 2
...
-- @param  Integer
-- @output Bool
-- @description: returns if a year entered is a leap year
-- Algorithm taken from https://support.microsoft.com/en-us/help/214019/method-to-determine-whether-a-year-is-a-leap-year
prob5 :: Int -> Bool
prob5 year
